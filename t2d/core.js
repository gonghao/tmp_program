...
function ddBuilder(template, blocks, variables) {
    ...
    existEstimateQueue = existEstimateQueue.map(function(src) {
        src = callee(src, blocks, variables);
        return src;
    });
...
exports.convertTheme = function(templateData) {
    var result, topLevel, allBlocks, allVariables;

    console.log('Theme file blocks parsing...');
    result = blockParser(templateData);
    templateData = result.source;
    topLevel = result.topLevel;

    console.log('Theme file variables parsing...');
    ...
    console.log('Start build diandian theme file...');
    ...
    console.log('Replace theme file variables...');
